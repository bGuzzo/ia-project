...
public class AstarCustom extends AbstractPlanner {
	...
	private static final long serialVersionUID = 2432746326170158850L;

	private static final Logger LOGGER = LogManager.getLogger(AstarCustom.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Max Depth: " + planner.maxDepth);
	...
	public Plan astar(Problem problem) {
		...
		//				&& time < timeout
			...
			if (current.getDepth() > maxDepthReached) {
				maxDepthReached = current.getDepth();
				LOGGER.info("Reached maximum depth: " + maxDepthReached + "\n");
			}
